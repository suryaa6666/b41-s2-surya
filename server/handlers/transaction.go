...
func (h *handlerTransaction) CreateTransaction(w http.ResponseWriter, r *http.Request) {
	...
	// var time int = int(time.Now().Unix())
	for !TransIdIsMatch {
...
func (h *handlerTransaction) Notification(w http.ResponseWriter, r *http.Request) {
	...
	if transactionStatus == "capture" {
		...
		// TODO set transaction status on your databaase to 'failure'		SendMail("failed", transaction) // Call SendMail function ...
		SendMail("failed", transaction) // Call SendMail function ...
		h.TransactionRepository.UpdateTransaction("failed", orderId)
...
func SendMail(status string, transaction models.Transaction) {
	...
	mailer.SetBody("text/html", fmt.Sprintf(`<!DOCTYPE html>
	  ...
	  </html>`, productName, price, status, "Ahsanu"))
